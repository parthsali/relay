...
export default function DevicePage() {
  ...
  const [secret, setSecret] = useState<{ id: string; secret: string } | null>(
    null,
  );
    ...
    <div className="flex w-full flex-1 flex-col">
      <div className="border-b border-border px-8 py-6">
        ...
        <p className="mt-0.5 text-sm text-muted-foreground">
          Register and monitor Relay Pi agents.
        </p>
      </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 px-4 py-3">
                      <span
                        className={`relative flex size-2 shrink-0 ${online ? "" : "opacity-40"}`}
                      >
                        {online && (
                        ...
                        {[
                          {
                            icon: Cpu,
                            label: "CPU",
                            value: `${t.cpu_percent.toFixed(1)}%`,
                          },
                          {
                            icon: Zap,
                            label: "RAM",
                            value: `${t.mem_mb.toFixed(0)} MB`,
                          },
                          {
                            icon: Thermometer,
                            label: "Temp",
                            value: `${t.temp_c.toFixed(1)}°C`,
                          },
                          {
                            icon: Clock,
                            label: "Uptime",
                            value: fmtUptime(t.uptime_s),
                          },
                          {
                            icon: Wifi,
                            label: "Wi-Fi",
