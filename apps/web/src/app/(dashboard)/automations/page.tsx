...
const automations = [
  {
    ...
    trigger: "Spotify starts playing",
    action: "Switch to Now Playing scene",
    active: true,
  },
  {
    name: "Work Hours",
    trigger: "Mon–Fri 09:00",
    action: "Show System Stats",
    active: true,
  },
  {
    name: "Night Mode",
    trigger: "Every day at 22:00",
    action: "Dim display to 10%",
    active: false,
  },
  {
    name: "High CPU",
    trigger: "CPU > 80%",
    action: "Show alert overlay",
    active: true,
  },
];
        ...
        <div className="overflow-hidden rounded-lg border border-border">
          {automations.map((a, i) => (
            ...
            >
              ...
              <span
                className={`text-xs font-medium px-2 py-0.5 rounded-full ${a.active ? "bg-emerald-500/10 text-emerald-500" : "bg-muted text-muted-foreground"}`}
              >
