...
const keys = [
  { name: "Production key", key: "rly_live_••••••••••••••••••••••3f9a", created: "Jun 12 2025", lastUsed: "Today" },
  { name: "Dev key", key: "rly_test_••••••••••••••••••••••8c2b", created: "May 3 2025", lastUsed: "Yesterday" },
];
    ...
    <div className="flex w-full flex-1 flex-col">
      <div className="flex w-full items-center justify-between border-b border-border px-8 py-6">
        <div>
          ...
          <p className="mt-0.5 text-sm text-muted-foreground">API keys, webhooks, and integration docs.</p>
        </div>
        <Button size="sm">
      ...
      <div className="flex flex-col gap-8 px-8 py-6">
        <div>
          ...
          <div className="overflow-hidden rounded-lg border border-border">
            {keys.map((k) => (
              <div key={k.name} className="flex items-center gap-4 border-b border-border px-4 py-4 last:border-0">
                ...
                <button className="flex size-7 items-center justify-center rounded-md hover:bg-accent text-muted-foreground hover:text-foreground transition-colors">
